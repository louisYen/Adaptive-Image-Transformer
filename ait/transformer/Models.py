...
from ait.transformer.Layers import EncoderLayer, DecoderLayer
from ait.modules.cells import conv2d_1x1
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        self.enc_emb = nn.Sequential(
            conv2d_1x1(d_word_vec*2, d_word_vec, bias=True),
        )
        ...
        self.dec_trans = nn.Sequential(
            conv2d_1x1(d_word_vec, d_word_vec*2, bias=True),
        )
